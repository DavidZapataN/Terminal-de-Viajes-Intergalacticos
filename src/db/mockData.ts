...
export const mockPlanetsNew: Planet[] = [
  {
    id: 'kepler-442b',
    name: 'Kepler-442b',
    system: 'Sistema Lyra',
  ...
  },
  {
    ...
    rating: 4.9,
    // reviews: 3924,
    images: ['https://images.unsplash.com/photo-1518066000-4b1b4adefcb4?w=800'],
    distance: 39.6,
    price: 25000,
    position: { x: 75, y: 20 },
  },
  ...
  },
  {
    ...
    rating: 4.3,
    // reviews: 1247,
    images: ['https://images.unsplash.com/photo-1551188449-8f0a48831b14?w=800'],
    distance: 13.8,
    price: 12000,
    position: { x: 85, y: 35 },
  },
...
export const mockPlanets: PlanetOld[] = [
  {
    id: 'kepler-442b',
    name: 'Kepler-442b',
    system: 'Sistema Lyra',
